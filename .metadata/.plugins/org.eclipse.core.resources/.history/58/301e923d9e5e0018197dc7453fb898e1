...
public class HttpUtils
{
	...
	public static boolean isQuad = false;
	...
	throws IOException
	{
		//By default SHARE ASK FOR QUADS
		System.out.println(String.format("posting RDF data to %s", url));
		//ContentType rdfXML = ContentType.NQ;
		ContentType rdfXML = ContentType.RDF_XML;
		System.out.println(String.format("get header to %s", rdfXML.getHTTPHeader()));
		...
		//System.out.println(String.format("#############get CONTENT TYPE!! %s", response.getEntity().getContentType()));
		int statusCode = response.getStatusLine().getStatusCode();
		//ContentType rdfXML = ContentType.RDF_XML;
		//System.out.println("estatus code="+statusCode);
		// String responseBody = EntityUtils.toString(response.getEntity());

		//	System.out.println("estatus code11="+responseBody);
	...
	throws IOException
	{
		//System.out.println(String.format("posting form data to %s\n%s", url, params));
		...
		//System.out.println(String.format("converting JSON object\n%s", json));
